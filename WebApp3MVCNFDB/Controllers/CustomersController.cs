...
using WebApp3MVCNFDB.Models;

namespace WebApp3MVCNFDB.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,Name,DocumentType,DocumentNumber")] Customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerID,Name,DocumentType,DocumentNumber")] Customers customers)
        {
            if (ModelState.IsValid)
            {
